"""Command-line code retrieval implementation."""
...
def display_selected_chunks(chunks: List[Dict[str, Any]]) -> None:
    ...
    if not chunks:
        ...
        print()
        print("Try:")
        print("  CODE_SCORE_THRESHOLD=0.0 ./ai-stack search code")
        print("  CODE_SCORE_THRESHOLD=0.20 ./ai-stack search code")
        print("  CODE_SCORE_THRESHOLD=0.25 ./ai-stack search code")
        return
...
def main() -> None:
    ...
    if len(sys.argv) > 1:
        ...
        display_selected_chunks(search_code(query=query, model=model, client=client))
        return
