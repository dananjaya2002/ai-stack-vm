...
Code-proxy and agentic-rag responses normalize retrieved code locations to
repository-relative paths and remove numbered source placeholders. Memory
locations returned by agentic-rag use filenames only.
